...
from .views import RegisterView, LoginView, task_management_view, ProjectListView, ProjectCreateView, TaskListView, TaskCreateView, TaskDetailView, CompletedTasksView, OverdueTasksView
